...
export function RicoChat({ className, onExpand, isExpanded = false, isCollapsed = false, onToggleCollapse }: RicoChatProps) {
  ...
  return (
    <div className={cn(
      ...
      {/* Header */}
      <div className="flex items-center justify-between px-4 py-3 border-b border-slate-200 bg-gradient-to-r from-violet-600 to-indigo-600 shrink-0">
        <div className="flex items-center gap-3">
          <div className="relative">
      ...
      <div 
        ref={scrollRef}
        className="flex-1 overflow-y-auto p-4 space-y-4 bg-slate-50 min-h-0"
      >
