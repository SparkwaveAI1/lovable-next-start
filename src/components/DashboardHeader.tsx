...
export function DashboardHeader({ selectedBusinessId, onBusinessChange }: DashboardHeaderProps) {
  return (
    <header className="sticky top-0 md:fixed md:top-0 md:left-0 md:right-0 z-50 border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 min-h-[100px] md:min-h-[72px]">
